# Mac を放置するとスタックちゃんの顔が出てくるスクリーンセーバを作った

※ note 貼り付け用。見出し（##）は note エディタ側で「大見出し / 小見出し」に直してください。
　ツイート・GitHub の URL は単独行のまま貼ると、note が自動でカード表示にします。
...
リポジトリ:
https://github.com/bruiselea/stackchan-screensaver
...
https://x.com/_I__l__l__l__I_/status/2062864911148146901
